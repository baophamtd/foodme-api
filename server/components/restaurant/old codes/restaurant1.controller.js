...
class restaurantController {
    ...
    searchRestaurants(req, res) {
        let {lat, lng, radiusMiles, radiusKilometers} = req.query;
        let radius = calculateRadius(radiusMiles, radiusKilometers);
        restaurantService.searchRestaurants(lat, lng, radius)
            .then(restaurants => {
    ...
    getRestaurantPhotos(req, res){
        let {id, limit} = req.query;
        return restaurantService.getRestaurantPhotos(id, limit)
            .then(results =>{
                res.send(results);
            })
    }
